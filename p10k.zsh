# Generated by Powerlevel10k configuration wizard on 2021-04-30 at 13:55 CEST.
...
# Display "toolbox" next to the OS icon when inside a toolbox container.
if [[ -f /run/.containerenv && -f /run/.toolboxenv ]]; then
  source /run/.containerenv
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='$P9K_CONTENT $name'
fi
  ################################[ prompt_char: prompt symbol ]################################
